...
This Water Book explains methods of victory as the long-sword form of the Ichi school. This <!-- Language does not extend to explaining the Way in detail, but it --> can be grasped intuitively. <!-- Study this book; read a word then ponder on it. If you interpret the meaning loosely you will mistake the Way.  -->
