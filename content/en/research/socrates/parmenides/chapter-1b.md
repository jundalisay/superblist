...
It has nothing to do with the resemblances, or whatever they are called from our viewpoint or sphere. <!-- , which are in our sphere, and from which we receive this or that name when we partake of them.  -->
